...
## Flutter Coder
**File**: `.claude/agents/flutter-coder.md`
...
## Ts.ED Backend Coder
**File**: `.claude/agents/tsed-backend-coder.md`
...
## Test Spec Generator
**File**: `.claude/agents/test-spec-generator.md`
...
## Migrator
**File**: `.claude/agents/migrator.md`
**Trigger**: `/migrate`
...
| `/jira done <id>` | Mark ticket Done in Jira → auto-creates PR via gh pr create |
...
| `/widgetbook` | Generate Widgetbook stories for all feature widgets and launch catalogue |
