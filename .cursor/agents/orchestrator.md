...
### Custom backend (tsed or node):
  ...
  Wave 5: Tests — unit + widget + Patrol integration tests (tester); always run
...
### Supabase / Firebase backend:
  ...
  Wave 5: Tests — unit + widget + Patrol integration tests against emulator (tester); always run
  Wave 6: Analytics events (analytics-agent)
  Wave 7: Review (reviewer)
...
### No backend (none):
  ...
  Wave 3: Tests — unit + widget + Patrol integration tests (tester); always run
