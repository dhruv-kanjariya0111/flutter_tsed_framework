---
name: refactor
description: Behavior-neutral code cleanup. Use for applying design tokens, extracting widget patterns, adding Semantics, improving error handling, or adding const constructors. Tests must pass before AND after. One focus area per session only.
---
