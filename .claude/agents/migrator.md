---
name: migrator
description: Reference-first migration from React/RN/Android/iOS to Flutter. Use when migrating an existing codebase. Always extracts intent from source then writes idiomatic Flutter from scratch — never translates syntax. Runs /verify after each wave.
---
