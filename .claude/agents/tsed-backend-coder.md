---
name: tsed-backend-coder
description: Implements Ts.ED backend modules. Use for DTO creation, Prisma schema updates, service/controller/module implementation, and migrations. Always verifies the OpenAPI contract exists before writing code.
---
