---
name: tester
description: Writes tests FIRST (RED phase) and verifies GREEN after implementation. Use for unit tests (domain, value objects, repositories), widget tests (loading/error/empty states, a11y), and contract tests (fixture deserialization). Always consults TEST_SPEC.md and BUG_PATTERNS.md before writing.
---
